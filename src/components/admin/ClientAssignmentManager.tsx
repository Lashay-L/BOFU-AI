...
export function ClientAssignmentManager({ isVisible, onClose }: ClientAssignmentManagerProps) {
  ...
  return (
    <BaseModal
      isOpen={isVisible}
      onClose={onClose}
      title="Client Assignment Manager"
      size="xl"
      theme="dark"
    >
      ...
      <div className="flex h-[70vh] border border-gray-700 rounded-lg overflow-hidden">
        {/* Left Panel - Admin List */}
        <div className="w-1/3 border-r border-gray-700 p-6 bg-gray-800/30">
          ...
          {selectedAdmin ? (
            ...
            <div className="h-full flex items-center justify-center text-gray-500">
              <div className="text-center">
                ...
                <p>Choose a sub-admin editor from the left panel to manage their client assignments</p>
              </div>
            </div>
          )}
        </div>
